...
namespace CoursesAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CourseContext>(c =>
            {
                c.UseSqlServer(Configuration.GetConnectionString("CourseConnection"));
            });
            ...
            a.UseSqlServer(Configuration.GetConnectionString("AuthenticationConnection")));
